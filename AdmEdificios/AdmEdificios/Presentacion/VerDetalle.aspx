    ...
    <div class="container margin-bottom">
        <div id="page-wrapper" class="col-md-6 col-md-offset-3">
            ...
            <div class="form-group">
                <asp:Label ID="lblNombre" Text="Nombre:" runat="server" for="lblNombreEdificio" />
            ...
            <div class="form-group">
                <asp:Label ID="lblBarrio" Text="Barrio:" runat="server" />
                <asp:Label ID="lblBarrioCABA" runat="server" />
            </div>

            <div class="form-group">
                <asp:Label ID="lblPosta" Text="Cod. Postal:" runat="server" />
                <asp:Label ID="lblCodPostal" runat="server" />
            </div>
            <div class="form-group">
                <asp:Label ID="lblPisos" Text="Cant. Pisos:" runat="server" />
                <asp:Label ID="lblCantPisos" runat="server" />
            </div>
            <div class="form-group">
                <asp:Label ID="lblDptos" Text="Cant. Dptos:" runat="server" />
                <asp:Label ID="lblCantDptos" runat="server" />
            </div>
            <div class="form-group">
                <asp:Label ID="lblCocheras" Text="Cant. Cocheras:" runat="server" />
                <asp:Label ID="lblCantCocheras" runat="server" />
            </div>
            <div class="form-group">
                <asp:Label ID="lblCreacion" Text="Año Creación:" runat="server" />
                <asp:Label ID="lblAnioCreacion" runat="server" />
            </div>

            <div class="form-group">
                <asp:Label ID="lblAmeni" Text="Amenities:" runat="server" />
                <asp:Label ID="lblAmenities" runat="server" />
            </div>

            <div class="form-group">
                <asp:Label ID="lblAlta" Text="Fecha de Alta:" runat="server" />
                <asp:Label ID="lblFechaAlta" runat="server" />
            </div>

            <div class="form-group">
                <asp:Label ID="lblComent" Text="Comentarios:" runat="server" />
