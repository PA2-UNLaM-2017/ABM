    ...
    <div class="container margin-bottom">
        <div id="page-wrapper" class="col-md-6 col-md-offset-3">
            ...
            <div class="form-group">
                ...
                <asp:TextBox class="form-control" runat="server" ID="txtNombreEdificio" ReadOnly="true" />
            </div>

            <div class="form-group">
                <asp:Label ID="lblDireccion" Text="Dirección:" runat="server" for="txtDireccion" />
                <asp:TextBox class="form-control" runat="server" ID="txtDireccion" ReadOnly="true" />
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    <asp:Label ID="lblCodPostal" Text="Cod. Postal:" for="txtCodPostal"
                        runat="server" />
                    <asp:TextBox class="form-control" runat="server" ID="txtCodPostal" ReadOnly="true" />
                </div>
                <div class="form-group col-md-6">
                    <asp:Label ID="lblCantPisos" Text="Cant. Pisos:" for="txtCantPisos"
                        runat="server" />
                    <asp:TextBox class="form-control" runat="server" ID="txtCantPisos" ReadOnly="true" />
                </div>
                <div class="form-group col-md-6">
                    <asp:Label ID="lblCantDptos" Text="Cant. Dptos:" for="txtCantDptos"
                        runat="server" />
                    <asp:TextBox class="form-control" runat="server" ID="txtCantDptos" ReadOnly="true" />
                </div>
                <div class="form-group col-md-6">
                    <asp:Label ID="lblCocheras" Text="Cant. Cocheras:" for="txtCocheras"
                        runat="server" />
                    <asp:TextBox class="form-control" runat="server" ID="txtCocheras" ReadOnly="true" />
                </div>
                <div class="form-group col-md-6">
                    <asp:Label ID="lblAnioCreacion" Text="Año Creación:" for="txtAnioCreacion"
                        runat="server" />
                    <asp:TextBox class="form-control" runat="server" ID="txtAnioCreacion" ReadOnly="true" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <asp:TextBox class="form-control" TextMode="MultiLine" runat="server" ID="txtComentarios"
                    placeholder="Escriba aquí algún comentario" ReadOnly="true" />
            </div>


             <div class="form-group">
                <asp:Button ID="btnRegresar" Text="Regresar" runat="server" class="btn btn-success" OnClick="btnRegresar_Click" />
            </div>
